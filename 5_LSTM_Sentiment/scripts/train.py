...
RESULTS_DIR = os.path.join(PROJECT_DIR, "results", "v1")
...
def main():
    ...
    #model
    model = SentimentLSTM(vocab_size=len(word_to_idx)).to(device)
    #word_to_idx = input encoding dictionary 
    #idx_to_word = decoding dictionary 
